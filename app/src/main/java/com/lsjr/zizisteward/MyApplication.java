...
public class MyApplication extends Application {
    ...
    public static String getUserId() {
        return EncryptUtils.addSign(Long.valueOf("77"), "u");
    }

    public static void setUserId(String userId) {
        //MyApplication.userId = EncryptUtils.addSign(Long.valueOf(userId), "u");
        MyApplication.userId=EncryptUtils.addSign(Long.valueOf("77"), "u");
    }
