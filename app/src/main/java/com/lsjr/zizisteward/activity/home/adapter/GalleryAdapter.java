...
public class GalleryAdapter extends RecyclerView.Adapter<GalleryAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        viewHolder.rlContent = (LinearLayout) view.findViewById(R.id.id_rl_content);
    ...
    private  void setBigImageLayouParams(ViewHolder holder) {
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(UIUtils.dp2px(42), UIUtils.dip2px(42));
    ...
    private void setSmaillImageLayouParams(ViewHolder holder) {
        ...
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(UIUtils.dp2px(35), UIUtils.dip2px(35));
       // layoutParams.addRule(RelativeLayout.CENTER_IN_PARENT);
        layoutParams.gravity= Gravity.CENTER;
        holder.imageView.setLayoutParams(layoutParams);
        //holder.textView.setLayoutParams(setBelowfoImageView(holder));
