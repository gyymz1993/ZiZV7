...
import com.lsjr.zizisteward.activity.home.fragment.TabHomeFragment;
import com.lsjr.zizisteward.activity.home.presenter.HomeActivityPresenter;
import com.lsjr.zizisteward.activity.home.presenter.HomePresenter;
import com.lsjr.zizisteward.activity.home.view.IHomeActivityView;
...
public class HomeActivity extends BaseMvpActivity<HomeActivityPresenter> implements IHomeActivityView {
        ...
        return new BottomTabView.OnTabItemSelectListener() {
            ...
            public void onTabItemSelect(int position) {
                if (getFragments().get(position) instanceof GroupFragment) {
                    ...
                    if (getFragments().get(position) instanceof TabHomeFragment ||
