...
// */
//
//public class TestHomeFragment extends BaseMvpFragment<HomePresenter> implements IHomeView {
...
//        gridCyclerView.setOnTouchListener(new OnTouchListener() {
//            @Override
...
//                ImageLoader.with().url(AppUrl.Http + advertisements.get(position).getImage_filename()).into(converView);
//                return converView;
//            }
//
//            @Override
...
//            }
//        });
//        bannerView.getmBannerVp().setOnTouchListener(new OnTouchListener() {
//            @Override
//            public boolean onTouch(View v, MotionEvent event) {
//                switch (event.getAction()) {
//                    case MotionEvent.ACTION_DOWN:
...
//        // showImage(igZiwei1, shouImg.getDiligentFood());
//    }
//
//    @Override
//    public void onError() {
