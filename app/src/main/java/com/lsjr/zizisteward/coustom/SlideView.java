...
public class SlideView extends LinearLayout implements AppBarLayout.OnOffsetChangedListener{
    ...
    public SlideView(Context context, AttributeSet attrs) {
        ...
        try {
            collapsedPadding = a.getDimension(R.styleable.SlideView_collapsedPadding, -1);
            expandedPadding = a.getDimension(R.styleable.SlideView_expandedPadding, -1);

            collapsedImageSize = a.getDimension(R.styleable.SlideView_collapsedImageSize, -1);
            expandedImageSize = a.getDimension(R.styleable.SlideView_expandedImageSize, -1);
